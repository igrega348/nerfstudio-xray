...
@dataclass
class TwofieldModelConfig(NerfactoModelConfig):
    """Template Model Configuration.

    Add your custom model config parameters here.
    """

    _target: Type = field(default_factory=lambda: TwofieldModel)
    ...
    deformation_field_f: DeformationFieldConfig = DeformationFieldConfig()
    """Forward deformation field"""
    deformation_field_b: DeformationFieldConfig = DeformationFieldConfig()
...
class TwofieldModel(Model):
    ...
    def populate_modules(self):
        ...
        self.deformation_field_f = self.config.deformation_field_f.setup()
        ...
        if not self.config.train_deformation_field:
            self.deformation_field_f.requires_grad_(False)
            self.deformation_field_b.requires_grad_(False)
